...
public class RutaCuentaBancariaCrear extends ControladorBancolombia {
    ...
    public void registrar(Router r) {
        ...
        r.get("/cuentasbancarias/crear", req -> {
            Map<String, Object> modelo = modeloBase();
            modelo.put("titulo", "Registrar Cuenta Bancaria");
            modelo.put("clientes", EnsambladorWeb.cliente().obtenerTodos());
            cargarMensajes(req, modelo);
            return vista("cuentasbancarias/crear.html", modelo);
        });

        r.post("/cuentasbancarias/crear", req -> {
            try {
                ...
                return redireccionar("/cuentasbancarias/crear");
            } catch (Exception e) {
